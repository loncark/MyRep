...
import com.loncar.composeapp.logger.LoginLogger
import com.loncar.composeapp.logger.RegisterLogger
                ...
                onLogin = {
                    authenticationViewModel.logIn(
                        onSuccess = {
                            ...
                            LoginLogger().templatePrint(personsViewModel.personsState.value.currentUserHandle)
            ...
            AuthenticationScreen(
                ...
                onRegister = {
                    if (authenticationViewModel.areHandleAndEmailUnique(
                        ...
                        personsViewModel.updatePersonsFirebaseDatabase(
                            ...
                            uploadSuccessfulToast = {
                                Toast.makeText(context, context.getString(R.string.register_successful), Toast.LENGTH_SHORT).show()
                            }
                        )
                        ...
                        authenticationViewModel.register(
                            onSuccess = {
                                ...
                                authenticationViewModel.clear()
                                RegisterLogger().templatePrint(personsViewModel.personsState.value.currentUserHandle)
                                navController.navigate(Graph.MAIN)
                            },
